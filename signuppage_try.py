...
def clear():
    ...
    qualificationLabel.delete(0, END)
    # qualificationEntry.delete(0, END)
    check.set(0)
#
# def connect_database():
#     if genderCombo.get() == '' or usernameEntry.get() == '' or passwordEntry.get() == '' or confirmEntry.get() == '' or contactEntry.get() == '' or qualificationLabel.get() == '' or addressEntry.get() == '':
...
#                 mycursor.execute(query, (id, genderCombo.get(), usernameEntry.get(), passwordEntry.get(), contactEntry.get(), qualificationLabel.get(),addressEntry.get()))
#                 con.commit()
